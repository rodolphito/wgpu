...
fn cs_main(@builtin(local_invocation_id) id: vec3<u32>) {
    ...
    workgroupBarrier();
    let _e163 = atomicAnd((&storage_atomic_scalar), 1u);
    let _e167 = atomicAnd((&storage_atomic_arr[1]), 1i);
    let _e171 = atomicAnd((&storage_struct.atomic_scalar), 1u);
    let _e176 = atomicAnd((&storage_struct.atomic_arr[1]), 1i);
    let _e179 = atomicAnd((&workgroup_atomic_scalar), 1u);
    let _e183 = atomicAnd((&workgroup_atomic_arr[1]), 1i);
    let _e187 = atomicAnd((&workgroup_struct.atomic_scalar), 1u);
    let _e192 = atomicAnd((&workgroup_struct.atomic_arr[1]), 1i);
    workgroupBarrier();
    let _e195 = atomicOr((&storage_atomic_scalar), 1u);
    let _e199 = atomicOr((&storage_atomic_arr[1]), 1i);
    let _e203 = atomicOr((&storage_struct.atomic_scalar), 1u);
    let _e208 = atomicOr((&storage_struct.atomic_arr[1]), 1i);
    let _e211 = atomicOr((&workgroup_atomic_scalar), 1u);
    let _e215 = atomicOr((&workgroup_atomic_arr[1]), 1i);
    let _e219 = atomicOr((&workgroup_struct.atomic_scalar), 1u);
    let _e224 = atomicOr((&workgroup_struct.atomic_arr[1]), 1i);
    workgroupBarrier();
    let _e227 = atomicXor((&storage_atomic_scalar), 1u);
    let _e231 = atomicXor((&storage_atomic_arr[1]), 1i);
    let _e235 = atomicXor((&storage_struct.atomic_scalar), 1u);
    let _e240 = atomicXor((&storage_struct.atomic_arr[1]), 1i);
    let _e243 = atomicXor((&workgroup_atomic_scalar), 1u);
    let _e247 = atomicXor((&workgroup_atomic_arr[1]), 1i);
    let _e251 = atomicXor((&workgroup_struct.atomic_scalar), 1u);
    let _e256 = atomicXor((&workgroup_struct.atomic_arr[1]), 1i);
    let _e259 = atomicExchange((&storage_atomic_scalar), 1u);
    let _e263 = atomicExchange((&storage_atomic_arr[1]), 1i);
    let _e267 = atomicExchange((&storage_struct.atomic_scalar), 1u);
    let _e272 = atomicExchange((&storage_struct.atomic_arr[1]), 1i);
    let _e275 = atomicExchange((&workgroup_atomic_scalar), 1u);
    let _e279 = atomicExchange((&workgroup_atomic_arr[1]), 1i);
    let _e283 = atomicExchange((&workgroup_struct.atomic_scalar), 1u);
    let _e288 = atomicExchange((&workgroup_struct.atomic_arr[1]), 1i);
    return;
}
