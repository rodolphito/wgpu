...
void cs_main(uint3 id : SV_GroupThreadID, uint3 __local_invocation_id : SV_GroupThreadID)
{
    ...
    GroupMemoryBarrierWithGroupSync();
    uint64_t _e_discard113; storage_atomic_scalar.InterlockedMax(0, 1uL, _e_discard113);
    int64_t _e_discard116; storage_atomic_arr.InterlockedMax(8, 1L, _e_discard116);
    uint64_t _e_discard119; storage_struct.InterlockedMax(0, 1uL, _e_discard119);
    int64_t _e_discard123; storage_struct.InterlockedMax(8+8, 1L, _e_discard123);
    uint64_t _e_discard125; InterlockedMax(workgroup_atomic_scalar, 1uL, _e_discard125);
    int64_t _e_discard128; InterlockedMax(workgroup_atomic_arr[1], 1L, _e_discard128);
    uint64_t _e_discard131; InterlockedMax(workgroup_struct.atomic_scalar, 1uL, _e_discard131);
    int64_t _e_discard135; InterlockedMax(workgroup_struct.atomic_arr[1], 1L, _e_discard135);
    GroupMemoryBarrierWithGroupSync();
    uint64_t _e_discard137; storage_atomic_scalar.InterlockedMin(0, 1uL, _e_discard137);
    int64_t _e_discard140; storage_atomic_arr.InterlockedMin(8, 1L, _e_discard140);
    uint64_t _e_discard143; storage_struct.InterlockedMin(0, 1uL, _e_discard143);
    int64_t _e_discard147; storage_struct.InterlockedMin(8+8, 1L, _e_discard147);
    uint64_t _e_discard149; InterlockedMin(workgroup_atomic_scalar, 1uL, _e_discard149);
    int64_t _e_discard152; InterlockedMin(workgroup_atomic_arr[1], 1L, _e_discard152);
    uint64_t _e_discard155; InterlockedMin(workgroup_struct.atomic_scalar, 1uL, _e_discard155);
    int64_t _e_discard159; InterlockedMin(workgroup_struct.atomic_arr[1], 1L, _e_discard159);
    GroupMemoryBarrierWithGroupSync();
